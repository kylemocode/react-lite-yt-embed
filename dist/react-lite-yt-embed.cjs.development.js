...
var LiteYoutubeEmbed = function LiteYoutubeEmbed(_ref) {
  ...
  var queryString = React.useMemo(function () {
    return qs(_extends({
      autoplay: '1',
      mute: muteParam
    }, params));
  ...
  var _useState2 = React.useState(defaultPlay),
      iframeLoaded = _useState2[0],
      setIframeLoaded = _useState2[1];

  var _useState3 = React.useState(defaultPosterUrl),
      posterUrl = _useState3[0],
      setPosterUrl = _useState3[1];

  var isWebpSupported = React.useRef(true);
  var warmConnections = React.useCallback(function () {
    if (isPreconnected) return;
    setIsPreconnected(true);
  }, []);
  var loadIframeFunc = React.useCallback(function () {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("link", {
    rel: 'preload',
    href: posterUrl,
    as: 'image'
  }), isPreconnected && React__default.createElement(React__default.Fragment, null, React__default.createElement("link", {
    rel: 'preconnect',
    href: ytUrl
  }), React__default.createElement("link", {
    rel: 'preconnect',
    href: 'https://www.google.com'
  })), isPreconnected && adLinksPreconnect && React__default.createElement(React__default.Fragment, null, React__default.createElement("link", {
    rel: 'preconnect',
  ...
  }), iframeLoaded && React__default.createElement("iframe", {
    width: '560',
    height: '315',
    frameBorder: '0',
...
exports.LiteYoutubeEmbed = LiteYoutubeEmbed;
//# sourceMappingURL=react-lite-yt-embed.cjs.development.js.map
